...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of D2LayoutHelperPod.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/D2LayoutHelperPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Brian Bowman' => 'brian.bowman@carrotcreative.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/D2LayoutHelperPod.git', :tag => s.version.to_s }
