...
+ (NSArray<NSLayoutConstraint *> *)pinItemtoCenterOfSuperView:(UIView *)superview
    ...
    NSArray<NSLayoutConstraint *> *constraints = [D20LayoutHelper constraintsForWidthAndHeightOnSuperView:superview
                                                                                                  subview:subview
                                                                                                    width:width
                                                                                                   height:height];
    
    constraints = [constraints arrayByAddingObjectsFromArray:[D20LayoutHelper pinItemtoCenterOfSuperView:superview
                                                                                                 subview:subview]];
